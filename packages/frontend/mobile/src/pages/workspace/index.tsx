...
import { MobileWorkbenchRoot } from '@affine/core/modules/workbench/view/mobile/workbench-root';
...
const workspaceRouter = createMemoryRouter(warpedRoutes);
...
export const Component = () => {
  ...
  return (
    <WorkspaceLayout meta={meta}>
      <MobileWorkbenchRoot router={workspaceRouter} />
    </WorkspaceLayout>
  );
};
